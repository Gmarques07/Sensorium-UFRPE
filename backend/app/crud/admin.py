...
def get_dashboard_stats(db: Session) -> Dict[str, Any]:
    ...
    """
    # Total de usuários
    total_usuarios = db.execute("SELECT COUNT(*) FROM usuarios").scalar()
    ...
    # Total de pedidos
    total_pedidos = db.execute("SELECT COUNT(*) FROM pedidos").scalar()
    
    # Total de notificações
    total_notificacoes = db.execute("SELECT COUNT(*) FROM notificacoes").scalar()
